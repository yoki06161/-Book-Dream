...
public class Prod_Service {
	...
	public void saveBooks(List<Prod_Books> book_list) {		
...
//    		System.out.println("!!!!!!!!!!!!!!!리턴 카카오 유저 이메일 " + mem_name);
    ...
    public boolean g_score(Integer bookId, String user) {
        Prod_Score score = sco_repo.findByBookAndUser(bookId, user);
